...
class ActionTimingConfig:
    ...
    # Text input related delays (in seconds)
    keyboard_switch_delay: float = 2.0  # Delay after switching to ADB keyboard
    text_clear_delay: float = 2.0  # Delay after clearing text
    text_input_delay: float = 2.0  # Delay after typing text
    keyboard_restore_delay: float = 2.0  # Delay after restoring original keyboard
...
class DeviceTimingConfig:
    ...
    default_tap_delay: float = 3.0  # Default delay after tap
    default_double_tap_delay: float = 1.5  # Default delay after double tap
    double_tap_interval: float = 0.1  # Interval between two taps in double tap
    default_long_press_delay: float = 3.0  # Default delay after long press
    default_swipe_delay: float = 3.0  # Default delay after swipe
    default_back_delay: float = 2.0  # Default delay after back button
    default_home_delay: float = 3.0  # Default delay after home button

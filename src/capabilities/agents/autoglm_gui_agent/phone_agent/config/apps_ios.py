...
def get_app_name(bundle_id: str) -> Optional[str]:
    """
...
def get_app_info_from_itunes(bundle_id: str) -> Optional[dict]:
    """
...
def get_app_info_by_id(app_store_id: str) -> Optional[dict]:
    """

...
class PhoneAgent:
    ...
    def _execute_step(
        ...
        try:
            ...
            if self.agent_config.verbose:
                print(f"Action parsing failed: {e}. Retrying...")
            # Instead of finishing, just wait and let the agent try again
            # This handles cases where the model outputs garbage or empty strings
